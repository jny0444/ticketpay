...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={`fixed bg-white text-black text-xl top-3 left-1/2 -translate-x-1/2 w-130 z-50 ${menuOpen ? "rounded-t-2xl rounded-b-none" : "rounded-2xl"} flex justify-between items-center px-6 py-3 duration-400`}
      >
        <motion.div
        ...
        >
          ...
          <AnimatePresence>
            {menuOpen && (
              <motion.div
                className="absolute top-full -left-6 bg-neutral-100 rounded-b-xl rounded-t-none py-5 w-130 flex flex-col justify-center items-center gap-1 border-t-2 border-neutral-300"
